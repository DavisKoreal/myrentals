...
class PaidHousesScreen extends StatefulWidget {
  const PaidHousesScreen({super.key});

  @override
  State<PaidHousesScreen> createState() => _PaidHousesScreenState();
}

class _PaidHousesScreenState extends State<PaidHousesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    _databaseService.totalPaidHouses().then((String value) => {
      setState(() {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text('PaidHouses', style: TextStyle(color: Colors.white)),
        actions: [
          IconButton(
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            Expanded(
              child: FutureBuilder(
                  future: _databaseService.getAllPaidHouses(),
                        ...
                        return ListTile(
                          ...
                          onTap: () {
                            ...
                            AlertDialog(
                                ...
                                content: Text('''
                              ${paidHouse.tenantName} of Building: ${paidHouse.buildingName} House: ${paidHouse.houseNumber} has paid their full rent
                            ''')
                            );
                          },
                        );
