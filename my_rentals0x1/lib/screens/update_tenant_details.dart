...
class UpdateTenantDetails extends StatefulWidget {
  const UpdateTenantDetails({super.key});

  @override
  State<UpdateTenantDetails> createState() => _UpdateTenantDetailsState();
}

class _UpdateTenantDetailsState extends State<UpdateTenantDetails> {
  static final DatabaseService _databaseService = DatabaseService.instance;
  final _rentPaidOptionsList = ["No", "Yes"];
  String? _selectedVal = "";

  _UpdateTenantDetailsState(){
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: backgroundColor,
        elevation: 0,
        title: const Text('Update the details of a tenant', style: TextStyle(color: Colors.white)),
      ),
      body: SafeArea(
        child: Padding(
            ...
            child: Column(
              ...
              children: [
                const Padding(
                  ...
                  child: Center(
                    child: Text(
                      'Enter new house details into system',
                ...
                Padding(
                  ...
                  child: Center(
                    child: ElevatedButton(
                        ...
                        showDialog(
                          ...
                          builder: (BuildContext context) {
                            ...
                            return AlertDialog(
                              ...
                              content: const Text('Update details successful '),
                              actions: <Widget>[
                                TextButton(
                      ...
                      child: const Text('Submit new details', style: TextStyle(color: Colors.black),),
                    ),
                  ),
                ),
