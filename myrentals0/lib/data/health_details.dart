...
class HealthDetails {
  List<HealthModel> healthData = [
    ...
    HealthModel(icon: 'assets/icons/paid_rent.jpg', value: "00.00", title: "Rent paid"),
    HealthModel(icon: 'assets/icons/unpaid_rent.jpeg', value: "00.00", title: "Remaining Rent"),
  ];
}