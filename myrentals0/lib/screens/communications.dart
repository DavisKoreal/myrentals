    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () {
          ...
          // List<String> numbers = _databaseService.getAllContactsInDatabase();
          // List<String> allContactNumbers = await _databaseService.getAllContactsInDatabase();
          Future<List<String>> allContactNumbers = _databaseService.getAllContactsInDatabase();
          allContactNumbers.then((value) =>
          {
            print("HERE I AM PRINTING ALL THE CONTACT NUMBERS THAT I HAVE IN THE DATABASE SO THAT WE CAN CONFIRM TAT THAT FUCKING FUNCTION IS ACTUALLY DOING WHAT IT IS SUPPOSED TO DO"),
            print(value),
            // sendMessage("This is a test message", value)
            print("THIS IS WHERE I VERY NEARLY RAN THE SEND MESSAGE MODULE")
          }
          );
          showDialog(
            context: context,
        ...
        label: const Text('Send a message to tenants'),
